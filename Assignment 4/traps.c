...
{
	printk(KERN_INFO "Name Dhairya Dhondiyal: do_trap_no_signal Triggered\n");
#ifdef CONFIG_X86_32
				...
				siginfo_t *info)
{
	...
	case X86_TRAP_DE:
		printk(KERN_INFO "Name Dhairya Dhondiyal: fill_trap_info \n");
		sicode = FPE_INTDIV;
			  ...
			  unsigned long trapnr, int signr)
{
	...
	printk(KERN_INFO "Name Dhairya Dhondiyal: do_error_trap Triggered \n");
...
{
	printk(KERN_INFO "Name Dhairya Dhondiyal: do_my_divide_error Triggered \n");
	printk(KERN_INFO "Name Dhairya Dhondiyal: Hacked!  \n");
